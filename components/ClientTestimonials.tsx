 ...
 * Includes names, businesses, ratings
 * 
 * Design: Card-based, scannable
 * Conversion: Builds trust and credibility
 */
...
const testimonials = [
    ...
    },
    {
        ...
        rating: 5,
        text: 'Working with Winni was a dream. She understood our luxury positioning perfectly and delivered a visual identity that screams premium. Our Instagram engagement tripled!',
        avatar: '👗'
    },
    {
        name: 'David Asante',
        ...
        role: 'Co-Founder',
        rating: 5,
        text: 'As a tech startup, we needed a modern brand that stood out. Winni delivered beyond expectations—fast turnaround, unlimited revisions, and a brand we're proud to show investors.',
    avatar: '💻'
  },
    {
        name: 'Portia Martey',
    ...
    },
    {
        ...
        role: 'Owner',
        rating: 5,
        text: 'Our logo and branding materials are so good, customers often think we're a franchise! The attention to detail and creativity is unmatched.Worth every cedi.',
    avatar: '🍛'
  },
    {
        name: 'Sarah Boateng',
                    ...
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 border-t border-brand-pink/10 pt-6">
                                {/* Avatar */}
                                <div className="w-12 h-12 bg-brand-pink/20 rounded-full flex items-center justify-center text-2xl">
                                    {testimonial.avatar}
                                </div>
