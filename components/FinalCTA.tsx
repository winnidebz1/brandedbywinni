      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-brand-dark/80 font-light max-w-2xl mx-auto mb-12">
            Get a modern website that speaks for your brand. Stop competing and start dominating your niche with a custom digital presence.
          </p>
          <a
            href="https://calendly.com/brandedbywinni/45min"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block px-10 py-4 bg-brand-ivory text-brand-pink font-medium tracking-wide rounded-full hover:bg-white hover:text-brand-dark transition-all duration-300 shadow-xl shadow-brand-dark/10 hover:shadow-2xl hover:-translate-y-1"
          >
