...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 px-6 md:px-12 bg-soft-gradient">
      <div className="container mx-auto grid grid-cols-12 gap-4 md:gap-12 items-center">
        ...
        <motion.div
          ...
          className="col-span-7 lg:col-span-8 flex flex-col justify-center"
        >
          <h1 className="font-serif text-2xl sm:text-3xl md:text-6xl lg:text-7xl leading-[1.1] text-brand-dark mb-4 md:mb-8">
        ...
        <motion.div
          ...
          className="col-span-5 lg:col-span-4 relative block h-[300px] md:h-[500px] lg:h-[600px] w-full"
        >
          {/* Decorative collage using simple divs and images */}
          <div className="absolute top-4 md:top-10 right-0 w-32 h-40 md:w-64 md:h-80 bg-gray-200 overflow-hidden rounded-lg shadow-xl rotate-3 hover:rotate-0 transition-transform duration-700">
            <img src="/hero-1.jpg" alt="Team Collaboration" className="w-full h-full object-cover opacity-90" />
          </div>
          <div className="absolute bottom-10 md:bottom-20 left-4 md:left-10 w-28 h-36 md:w-56 md:h-72 bg-gray-300 overflow-hidden rounded-lg shadow-2xl -rotate-6 hover:rotate-0 transition-transform duration-700 z-10">
