    ...
    <div className="relative h-full w-full max-w-2xl overflow-hidden flex items-center justify-center lg:justify-start">
      <AnimatePresence mode="wait">
        <motion.p
          ...
          className="text-base text-brand-dark font-medium bg-brand-pink/10 px-4 py-2 rounded-full border border-brand-pink/20 absolute"
        >
          {messages[index]}
        </motion.p>
      </AnimatePresence>
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-center">
            ...
            <a href="https://wa.me/233244591777" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-8 py-3 bg-brand-dark text-white font-light tracking-wide rounded-sm hover:bg-brand-pink transition-colors duration-300 w-fit">
