...
const steps: Step[] = [
  {
    ...
    description: 'We start with a detailed consultation to understand your business, goals, target audience, and brand vision. This ensures we are aligned from day one.',
    duration: '1-2 days'
  },
  {
    number: '02',
    icon: Palette,
    title: 'Design & Refine',
    description: 'Our team creates initial concepts based on our strategy session. You review, provide feedback, and we refine until it is perfect, with unlimited revisions included.',
    duration: '3-7 days'
  },
  {
    number: '03',
    ...
    description: 'You receive all final files in multiple formats, ready to use across all platforms. We also provide brand guidelines and ongoing support.',
    duration: '1-2 days'
  }
];
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-brand-text font-light leading-relaxed">
            A simple, proven 3-step process that delivers results with clarity.
          </p>
        </div>
