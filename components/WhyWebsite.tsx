                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
                    {benefits.map((item, index) => (
                        <motion.div
                            ...
                            className="p-4 md:p-8 bg-brand-ivory rounded-2xl border border-brand-pink/10 hover:border-brand-pink/40 transition-colors group cursor-default flex flex-col items-center text-center h-full hover:shadow-lg hover:shadow-brand-pink/5"
                        >
